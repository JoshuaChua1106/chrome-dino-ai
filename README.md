# Project Overview
This is a Chrome Dino Game AI built using Python, Pygame, and the NEAT (NeuroEvolution of Augmenting Topologies) algorithm. 

The project recreates the classic offline dinosaur jumping game and trains neural networks to play it autonomously. The AI receives four sensor inputs: dino height, distance to the nearest obstacle, obstacle height,
